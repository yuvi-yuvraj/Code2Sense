        ...
        <div className='h-full w-full flex flex-col items-center'>
          <h1 className='text-6xl font-bold text-lavender pt-24'>Voice To Text</h1>
            ...
            <div className='flex lg:flex-row flex-col gap-28 p-16 justify-center items-center'>
              ...
              <div className='max-w-[400px] object-cover rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 ease-in-out hover:brightness-110'>
              <img src={voice} alt="img1" className=''/>
              </div>
            </div>
          </div>
